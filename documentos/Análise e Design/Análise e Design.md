...
***
Na classe “mudar_estado” vai encaminha diretamente para classe “componentes_voz” como o método denominado “threads()” que é um void(função que não retorna nada), por fim vai finalizar classe “mudar_estado”.
***
