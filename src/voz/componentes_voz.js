        ...
        try{
            ...
            case "parte_1":
                let parte_1 = [
                    ...
                    parte_1[0].linhas.length != 0 ?  parte_1[0].index =  parte_1[0].index  + 1 :  parte_1[0].index  = 0;
                    break;
            }
        }catch(ev){
            console.log(ev);
                        ...
                        threads_voz[0].postMessage([sequencia_primeira_parte[0]]);
                            ...
                            function parte_1()
                            {
                             threads_voz[2].onmessage = event=>{
                                 this.Roteiro(sequencia_primeira_parte[2]);    
                                 var resposta  = this.falar;   
                                 v.transmitir(resposta);     
                                 threads_voz.pop();
                                 threads_voz.pop();
                                 ...
                                 clearTimeout(três_segundos);
                             }   
                            }
                           var três_segundos = window.setTimeout(parte_1,3000);
